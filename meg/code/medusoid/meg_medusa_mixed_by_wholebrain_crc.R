...
# random slope of v_entropy
  encode_formula_rs_e_kld = formula(~ trial_neg_inv_sc + rt_csv_sc + rt_lag_sc + kld3 +
  ...
  encode_formula_rs_e_kld =  formula(~ reward_lag + rt_csv_sc + rt_lag_sc + trial_neg_inv_sc + kld3 +
