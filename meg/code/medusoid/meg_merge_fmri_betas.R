...
betas <- read_csv("/Volumes/GoogleDrive/.shortcut-targets-by-id/1ukjK6kTlaR-LXIqX6nylYOPWu1j3XGyF/SCEPTIC_fMRI/final_betas/L1m-echange_abspe/Schaefer_DorsAttn_2.3mm_zstat_l2.csv.gz")  %>%
