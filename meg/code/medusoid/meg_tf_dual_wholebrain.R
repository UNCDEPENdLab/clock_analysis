        ...
        if (regressor=="entropy_change") {
          file_pattern <- "*_change_rs_single_.*clock"} else if (regressor=="entropy") {
            file_pattern <- "_entropy_rs.*clock"} else if (regressor=="kld") {
              file_pattern <- ".*kld.*clock"} else if (regressor=="entropy_change_pos_ri") {
                file_pattern <- ".*entropy_change_pos_rs.*clock"} else if (regressor=="entropy_change_neg_ri") {
                                    ...
                                    file_pattern <- ".*entropy_change_fmr1.*RT"} else if (regressor == "entropy_change_fmr2") {
                                      file_pattern <- ".*entropy_change_fmr2.*RT"} else if (regressor == "entropy_change_fmri_ppc") {
                                        file_pattern <- ".*wholebrain_entropy_change_fmri_ppc.*RT"} else if (regressor == "entropy_change_fmri_ppc_ec_sensors") {
                                          ...
                                          file_pattern <- ".*abspe_ec_sensors.*RT"} else if (regressor == "entropy_change_ec_sensors") {
