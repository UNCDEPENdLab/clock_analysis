...
alldirs=$( find /Volumes/Serena/SPECC/MR_Proc -iname "clock[0-9]" -ipath "*mni_5mm_wavelet*" -type d | grep -v bbr_exclude )
...
for d in $alldirs; do
    ...
    refimg=$( find -L "/Volumes/Serena/SPECC/WPC-6290_MB" -ipath "*WPC6290-*${id}*" -iname  "*ref.hdr" | head -1 )
    #if [ ! -d bbr_noref ]; then
