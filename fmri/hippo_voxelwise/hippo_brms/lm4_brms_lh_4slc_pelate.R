...
lm4_lh_4slc_pelate <- brm(b3 + b6 + b9 + b12 + set_rescor(TRUE), data = fb_l_lags, chains = 4, cores = 4, autocor = cor_arma(~run_trial|id, 1), iter=2500)

summary(lm4_lh_4slc_pelate)

save(lm4_lh_4slc_pelate, file="output/lm4_brms_lh_4slc_pelate.RData")
