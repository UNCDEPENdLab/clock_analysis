...
lm1_lh_6slc_unsmoothed <- brm(b2 + b4 + b6 + b8 + b10 + b12 + set_rescor(TRUE), data = fb_l_lags,
  chains = 4, cores = 4, autocor = cor_arma(~run_trial|id, 1), iter=2500, init_r=0.9)

summary(lm1_lh_6slc_unsmoothed)

save(lm1_lh_6slc_unsmoothed, file="output/lm1_brms_lh_6slc_unsmoothed.RData")
