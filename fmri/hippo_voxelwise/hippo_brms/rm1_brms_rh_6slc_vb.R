...
rm1_rh_6slc <- brm(b2 + b4 + b6 + b8 + b10 + b12 + set_rescor(TRUE), data = fb_r_lags,
  chains = 4, cores = 4, autocor = cor_arma(~run_trial|id, 1), algorithm="fullrank")

summary(rm1_rh_6slc)

save(rm1_rh_6slc, file="output/rm1_brms_rh_6slc_vb.RData")
