...
cp ${Schaefer_srcdir}/Schaefer2018_200Parcels_7Networks_order_FSLMNI152_1mm_ants.nii.gz .
...
ResampleImageBySpacing 3 Schaefer2018_200Parcels_7Networks_order_FSLMNI152_1mm_ants.nii.gz Schaefer2018_200Parcels_7Networks_order_FSLMNI152_${sz}mm_ants.nii.gz ${sz} ${sz} ${sz} 0 1 1 #0 no smoothing, 1 for 1 voxel padding, 1 for nearest neighbor

immv Schaefer2018_200Parcels_7Networks_order_FSLMNI152_1mm_ants high_res_originals
...
fslmaths l_bla_${sz}mm.nii.gz -add 200 -thr 201 l_bla_${sz}mm_201.nii.gz
fslmaths r_bla_${sz}mm.nii.gz -add 201 -thr 202 r_bla_${sz}mm_202.nii.gz
fslmaths l_cmn_${sz}mm.nii.gz -add 202 -thr 203 l_cmn_${sz}mm_203.nii.gz
fslmaths r_cmn_${sz}mm.nii.gz -add 203 -thr 204 r_cmn_${sz}mm_204.nii.gz
...
fslmaths l_thal_${sz}mm -add 204 -thr 205 l_thal_${sz}_renumber
fslmaths r_thal_${sz}mm -add 208 -thr 209 r_thal_${sz}_renumber
...
fslmaths l_striatum_tight_7Networks_${sz}mm -add 212 -thr 213 l_striatum_tight_7Networks_${sz}mm_renumber
fslmaths r_striatum_tight_7Networks_${sz}mm -add 217 -thr 218 r_striatum_tight_7Networks_${sz}mm_renumber
...
fslmaths Schaefer2018_300Parcels_7Networks_order_FSLMNI152_2.3mm_ants -add l_bla_${sz}mm_201 -add r_bla_${sz}mm_202 -add l_cmn_${sz}mm_203 -add r_cmn_${sz}mm_204 \
