...
get_trial_data <- function(repo_directory=NULL, dataset="mmclock_fmri", groupfixed=TRUE) {
  ...
  if (dataset=="mmclock_fmri") {
    ...
    if (isTRUE(groupfixed)) {
      load(file.path(repo_directory, "fmri/data/bsocial/decay_merged.RData")) 
      trial_df <- decay_merged #%>% rename(id = ID, rt_csv = rt, score_csv = score)
    } else {
      trial_df <- read_csv(file.path(repo_directory, "fmri/data/bsocial/mmclock_fmri_decay_factorize_selective_psequate_mfx_trial_statistics.csv.gz"))
    }
    trial_df <- trial_df %>% mutate (scanner_run = run, run = case_when (ID==203264|ID==203521|ID==204252|ID==206468|ID==211858|ID==211973|ID==212298|ID==218135|ID==218275|
    ID==219084|ID==219475|ID==219757|ID==220392|ID==220419|ID==220487|ID==220525|ID==220530|ID==220562|ID==220590|ID==220622|ID==220625|ID==220637|ID==220643|ID==220686|ID==220691|
    ID==220762|ID==220831|ID==220875|ID==220886|ID==220955|ID==32765 ~ ceiling(trial/50),TRUE~ceiling(trial/40)), run_trial = case_when(ID==203264|ID==203521|ID==204252|ID==206468|
    ID==211858|ID==211973|ID==212298|ID==218135|ID==218275|ID==219084|ID==219475|ID==219757|ID==220392|ID==220419|ID==220487|ID==220525|ID==220530|ID==220562|ID==220590|ID==220622|
    ID==220625|ID==220637|ID==220643|ID==220686|ID==220691|ID==220762|ID==220831|ID==220875|ID==220886|ID==220955|ID==32765 ~ trial-(run-1)*50, TRUE~trial - (run-1)*40)) %>% dplyr::rename(id = "ID", rt_csv = "rt", score_csv = "score")
    
  } else {
    stop("Don't know how to interpret dataset")
  }
  
  if (dataset != "bsocial") {trial_df <- trial_df %>% mutate(run_trial = trial - (run - 1) * !!trials_per_run)}
  trial_df <- trial_df %>%
