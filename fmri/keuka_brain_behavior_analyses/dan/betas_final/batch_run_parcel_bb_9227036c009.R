...
to_plot <- mixed_by_betas('/Volumes/GoogleDrive/My Drive/SCEPTIC_fMRI/wholebrain_betas/L1m-echange/Schaefer2018_200Parcels_7Networks_order_fonov_2.3mm_ants_cope_l2.csv.gz', labels_df, trial_df, mask_file = 'Schaefer_444_final_2.3mm.nii.gz',
